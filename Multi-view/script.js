const steps = document.querySelectorAll(".stp"); //4
const circleSteps = document.querySelectorAll(".step"); //4
const formInputs = document.querySelectorAll(".step-1 form input"); //4
const plans = document.querySelectorAll(".plan-card"); // 3
const switcher = document.querySelector(".switch"); //1
const addons = document.querySelectorAll(".box"); // 4
const total = document.querySelector(".total b"); //1
const planPrice = document.querySelectorAll(".plan-price"); //4
let time;
let currentStep = 1;
let currentCircle = 0;
const obj = {
...
function setTotal() {
    const str = planPrice[0].innerHTML;
